...
🗺️ Simulation DetailsThe simulation network is built using OpenStreetMap data covering an approximately 1.5 km² area comprising Ankara's central business district.  
